...
/**
 * Puts UI-kit widgets on a vanilla screen (death screen, anvil): draws them after the screen and routes clicks to
...
public final class ScreenWidgets {
    ...
    public static ScreenWidgets attach(Screen screen, Layout layout) {
        ...
        ScreenEvents.afterRender(screen).register((s, graphics, mouseX, mouseY, delta) -> widgets.render(graphics, layout));
