...
final class GearReader {
    ...
    static SlotView read(EquipmentSlot slot, ItemStack stack, boolean assumeUndamaged, @Nullable Level level) {
    ...
    /** One line for debug.log: item id, durability decision and enchantment ids with levels. */
    static String describe(ItemStack stack, boolean assumeUndamaged) {
        if (stack.isEmpty()) {
